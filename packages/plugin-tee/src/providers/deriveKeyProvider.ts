...
class DeriveKeyProvider {
    ...
    async deriveEd25519Keypair(
        ...
        try {
            ...
            elizaLogger.log("Deriving Key in TEE..2323.1");
            elizaLogger.log("Deriving Key in TEE33:", path, subject);
            const derivedKey = await this.client.deriveKey(path, subject);
    ...
    get: async (runtime: IAgentRuntime, _message?: Memory, _state?: State) => {
        ...
        try {
            ...
            try {
                ...
                elizaLogger.debug("Solana secretSalt:", secretSalt);
                elizaLogger.debug("Solana Agent ID:", agentId);
